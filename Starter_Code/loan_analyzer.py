...
def pvc(future_value, remaining_months, annual_discount_rate):
    present_value_calculation = future_value / (1 + (annual_discount_rate/12)) ** remaining_months
    present_value_loan = present_value_calculation
    
    return present_value_loan
...
present_value_newloan = pvc(
    new_loan["future_value"],
    new_loan["remaining_months"],
    annual_discount_rate)

print(f"The present value of the loan is: {present_value_newloan: .2f}")
